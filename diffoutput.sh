dirs()
{
  find $1 -path "*.strings" -prune -o -path "*msgtable*" -prune -o -name '*' -type d -print | cut -sd / -f 4- | sort | uniq
  find $2 -path "*.strings" -prune -o -path "*msgtable*" -prune -o -name '*' -type d -print | cut -sd / -f 4- | sort | uniq
